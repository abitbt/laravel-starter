                    ...
                    @if (auth()->user()->two_factor_secret)
                        ...
                        @if (session('status') == 'two-factor-authentication-enabled')
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-secondary">Store these recovery codes in a secure password manager. They can be used to recover access to your account if your two factor authentication device is lost.</p>
