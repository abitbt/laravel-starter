                      ...
                      <form class="space-y">
                        <div class="row">
                          <div class="col-6">
                            ...
                            <input type="text" placeholder="Name" class="form-control" id="basic-name"
                              name="name" />
                          </div>
                          <div class="col-6">
                            <label class="form-label visually-hidden" for="basic-email">Email address</label>
                            <input type="email" placeholder="Email address" class="form-control" id="basic-email"
                              name="email" />
                          </div>
                        </div>
                        <div>
                          <label class="form-label visually-hidden" for="basic-password">Password</label>
                          <input type="password" placeholder="Password" class="form-control" id="basic-password"
                            name="password" />
                        </div>
                        <div>
                          <label class="form-label visually-hidden" for="basic-password-confirm">Confirm
                            Password</label>
                          <input type="password" placeholder="Confirm Password" class="form-control"
                            id="basic-password-confirm" name="password_confirm" />
                        </div>
                        <div>
                        ...
                        <div class="space-y">
                          <div>
                            ...
                            <input type="text" placeholder="Enter first name" class="form-control"
                              id="example-first-name" name="first_name" />
                          </div>
                          <div>
                            <label class="form-label" for="example-last-name"> Last Name </label>
                            <input type="text" placeholder="Enter last name" class="form-control"
                              id="example-last-name" name="last_name" />
                          </div>
                          <div>
                            ...
                            <div class="col-auto">
                              <a href="#" class="btn btn-primary btn-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  ...
                                  focusable="false" class="icon icon-end icon-2">
                                  <path d="M5 12l14 0" />
                                  <path d="M13 18l6 -6" />
                                  <path d="M13 6l6 6" />
                                </svg>
                        ...
                        <div class="space-y">
                          ...
                          <div class="row row-cols-2 g-4">
                            ...
                            <div>
                              ...
                              <div>
                                <div class="input-icon">
                                  <input class="form-control" placeholder="Select a date" id="datepicker-birth-date"
                                    value="2020-06-20" />
                                  <span
