...
<head>
  ...
  <title>2-Step Verification - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.
  </title>
    ...
    <div class="container-tight container py-4">
      ...
      <form class="card card-md" action="./" method="get" autocomplete="off" novalidate>
        <div class="card-body">
          ...
          <p class="my-4 text-center">Please confirm your account by entering the authorization code sent to <strong>+1
              856-672-8552</strong>.</p>
          <div class="my-5">
            <div class="row g-4">
              <div class="col">
                <div class="row g-2">
                  <div class="col">
                    <input type="text" class="form-control form-control-lg px-3 py-3 text-center" maxlength="1"
          ...
          <div class="form-footer">
            <div class="btn-list flex-nowrap">
              <a href="/2-step-verification.html" class="btn btn-3 w-100"> Cancel </a>
              <a href="#" class="btn btn-primary btn-3 w-100"> Verify </a>
            </div>
          </div>
        </div>
      </form>
      <div class="text-secondary mt-3 text-center">It may take a minute to receive your code. Haven't received it? <a
          href="./">Resend a new code.</a></div>
    </div>
  </div>
