          ...
          <div class="row row-cards">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="text-secondary">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto at consectetur culpa ducimus
                    eum fuga fugiat, ipsa iusto, modi
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card bg-primary text-primary-fg">
                <div class="card-stamp">
                  <div class="card-stamp-icon text-primary bg-white">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="text-secondary">
                    ...
                    itaque minima neque pariatur perferendis
                ...
                <div class="row row-0">
                  <div class="col-3">
                    ...
                    <img
                      ...
                      class="w-100 h-100 card-img-start object-cover"
                ...
                <div class="row row-0">
                  <div class="col-3 order-md-last">
                    ...
                    <img src="./static/photos/finances-us-dollars-and-bitcoins-currency-money.jpg"
                      class="w-100 h-100 card-img-end object-cover"
                  ...
                  <div class="row align-items-center">
                    <div class="col-auto ms-auto">
                      <div class="avatar-list avatar-list-stacked">
                        ...
                        <span class="avatar avatar-2"> +3 </span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-content">
                  ...
                  <div id="tab-top-1" class="card tab-pane active show">
                    <div class="card-body">
                      ...
                      <p class="text-secondary">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, alias aliquid distinctio
                        dolorem expedita, fugiat hic magni
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="card-tabs">
                ...
                <ul class="nav nav-tabs nav-tabs-bottom">
                  <li class="nav-item"><a href="#tab-bottom-1" class="nav-link active" data-bs-toggle="tab">Tab
                      1</a></li>
              ...
              <div class="row row-cards row-deck">
                ...
                <div class="col">
                  <div class="card">
                    ...
                    <div class="card-body">This card has supporting text below as a natural lead-in to additional
                      content.</div>
                    <div class="card-footer">Last updated 3 mins ago</div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    ...
                    <div class="card-body">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
                      card has even longer content than the
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="empty">
                  ...
                  <p class="empty-subtitle text-secondary">Try adjusting your search or filter to find what you're
                    looking for.</p>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="mb-3">
                    ...
                    <input type="text" name="input-mask" class="form-control" data-mask="0000 0000 0000 0000"
