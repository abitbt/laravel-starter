          ...
          <div class="row row-cards">
                  ...
                  <div class="row align-items-center">
                    <div class="col-10">
                      ...
                      <div class="markdown text-secondary fs-3">
                        80 eye-catching, customizable and responsive email templates to improve your email
                        communication. No coding skills needed.
                      </div>
                      <div class="mt-3">
                        <a href="https://r.tabler.io/buy-emails" class="btn btn-primary" target="_blank">Buy all emails
                          for $29</a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-12">
              <div class="row row-cards" data-masonry='{"percentPosition": true }'>
                <div class="col-4">
                  <a href="./static/emails/absence.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/absence.jpg" class="img-fluid rounded"
                      alt="Email template about absence to employees at work" width="1248" height="1616" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/access-token.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/access-token.jpg">
                    <img src="./static/emails/access-token.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1032" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/account-deleted.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/account-deleted.jpg">
                    <img src="./static/emails/account-deleted.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1152" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/activities.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/activities.jpg" class="img-fluid rounded"
                      alt="Email template related to the activities" width="1248" height="2130" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/blog-post.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/blog-post.jpg" class="img-fluid rounded"
                      alt="Email template about posted blog posts" width="1248" height="2506" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/calendar.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/calendar.jpg">
                    <img src="./static/emails/calendar.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="2744" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/changelog.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/changelog.jpg">
                    <img src="./static/emails/changelog.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1956" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/collection.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/collection.jpg" class="img-fluid rounded"
                      alt="Email template about the proposition of the collection" width="1248" height="2774" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/company-email.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/company-email.jpg">
                    <img src="./static/emails/company-email.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1604" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/conference.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/conference.jpg" class="img-fluid rounded"
                      alt="Email template with an invitation to a conference" width="1248" height="3686" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/confirm-email.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/confirm-email.jpg">
                    <img src="./static/emails/confirm-email.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1484" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/confirmation.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/confirmation.jpg" class="img-fluid rounded"
                      alt="Email template with the booking confirmation" width="1248" height="4450" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/deployment-failed.jpg" data-bs-toggle="modal"
                    data-bs-target="#email-modal" data-bs-title="" data-bs-description=""
                    data-bs-image="./static/emails/deployment-failed.jpg">
                    <img src="./static/emails/deployment-failed.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1906" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/domain-configuration.jpg" data-bs-toggle="modal"
                    data-bs-target="#email-modal" data-bs-title="" data-bs-description=""
                    data-bs-image="./static/emails/domain-configuration.jpg">
                    <img src="./static/emails/domain-configuration.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1474" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/download.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/download.jpg" class="img-fluid rounded"
                      alt="Email template with message about the completed download" width="1248" height="1244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/empty.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/empty.jpg" class="img-fluid rounded"
                      alt="Empty email template for modifications" width="1248" height="244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/error.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/error.jpg" class="img-fluid rounded"
                      alt="Email template with informaton about the error" width="1248" height="1596" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/event-invitation.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/event-invitation.jpg" class="img-fluid rounded"
                      alt="Email template with an invitation to a event" width="1248" height="1974" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/featured-photo.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/featured-photo.jpg" class="img-fluid rounded"
                      alt="Email template with the featured photo" width="1248" height="2614" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/features.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/features.jpg" class="img-fluid rounded"
                      alt="Email template for the features" width="1248" height="3536" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/features-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/features-2.jpg" class="img-fluid rounded"
                      alt="Email template with new features" width="1248" height="2652" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/features-3.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/features-3.jpg">
                    <img src="./static/emails/features-3.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1340" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/footer-1.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/footer-1.jpg">
                    <img src="./static/emails/footer-1.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/footer-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/footer-2.jpg">
                    <img src="./static/emails/footer-2.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/footer-3.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/footer-3.jpg">
                    <img src="./static/emails/footer-3.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/footer-4.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/footer-4.jpg">
                    <img src="./static/emails/footer-4.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="244" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/friend-request.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/friend-request.jpg" class="img-fluid rounded"
                      alt="Email template for a friend request" width="1248" height="1344" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/gdpr.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/gdpr.jpg" class="img-fluid rounded" alt="Email template about GDPR"
                      width="1248" height="3072" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/help.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/help.jpg" class="img-fluid rounded"
                      alt="Email template with help to users" width="1248" height="2606" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/invitation.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/invitation.jpg" class="img-fluid rounded"
                      alt="Email template with an invitation to collaborate" width="1248" height="1294" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/invitation-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/invitation-2.jpg">
                    <img src="./static/emails/invitation-2.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1652" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/invoice.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/invoice.jpg" class="img-fluid rounded"
                      alt="Email template with an invoice" width="1248" height="3366" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/last-conversation.jpg" data-bs-toggle="modal"
                    data-bs-target="#email-modal" data-bs-title="Email template with the last conversation"
                    ...
                    <img src="./static/emails/last-conversation.jpg" class="img-fluid rounded"
                      alt="Email template with the last conversation" width="1248" height="2524" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/license.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/license.jpg" class="img-fluid rounded"
                      alt="Email template related with the license" width="1248" height="1730" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/magic-link.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/magic-link.jpg">
                    <img src="./static/emails/magic-link.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1180" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/message.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/message.jpg" class="img-fluid rounded"
                      alt="Email template with a new message" width="1248" height="1964" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/missing-order.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/missing-order.jpg" class="img-fluid rounded"
                      alt="Email template with the missing order" width="1248" height="1776" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/new-app.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/new-app.jpg">
                    <img src="./static/emails/new-app.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1270" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/new-photos.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/new-photos.jpg">
                    <img src="./static/emails/new-photos.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1768" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/newsletter.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/newsletter.jpg" class="img-fluid rounded"
                      alt="Email template showing the newsletter" width="1248" height="5290" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/off-deals.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/off-deals.jpg">
                    <img src="./static/emails/off-deals.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="2508" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/offer.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/offer.jpg" class="img-fluid rounded"
                      alt="Email template with promocional offer" width="1248" height="1228" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/order.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/order.jpg" class="img-fluid rounded"
                      alt="Email template with order summary" width="1248" height="3688" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/otp-code.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/otp-code.jpg">
                    <img src="./static/emails/otp-code.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1908" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/password.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/password.jpg" class="img-fluid rounded"
                      alt="Email template with reset password for the account" width="1248" height="1196" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/payment.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/payment.jpg" class="img-fluid rounded"
                      alt="Email template with payment details" width="1248" height="1812" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/popular-posts.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/popular-posts.jpg" class="img-fluid rounded"
                      alt="Email template with popular post" width="1248" height="3196" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/post.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/post.jpg">
                    <img src="./static/emails/post.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1504" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/pricing.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/pricing.jpg" class="img-fluid rounded"
                      alt="Email template with the given pricing" width="1248" height="1480" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/product-available.jpg" data-bs-toggle="modal"
                    data-bs-target="#email-modal" data-bs-title="Email template with an available product"
                    ...
                    <img src="./static/emails/product-available.jpg" class="img-fluid rounded"
                      alt="Email template with an available product" width="1248" height="2122" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/progress.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/progress.jpg" class="img-fluid rounded"
                      alt="Email template with progress" width="1248" height="1354" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/projects.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/projects.jpg" class="img-fluid rounded"
                      alt="Email template with a project overview" width="1248" height="1640" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/promo-code.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/promo-code.jpg" class="img-fluid rounded"
                      alt="Email template associated with promo code." width="1248" height="1342" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/promotions.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/promotions.jpg">
                    <img src="./static/emails/promotions.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="3058" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/promotions-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/promotions-2.jpg">
                    <img src="./static/emails/promotions-2.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1626" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/register.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/register.jpg" class="img-fluid rounded"
                      alt="Email template about the registration of a new user" width="1248" height="1464" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/reminder.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/reminder.jpg" class="img-fluid rounded"
                      alt="Email template with an event reminder" width="1248" height="1152" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/repo-stats.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/repo-stats.jpg" class="img-fluid rounded"
                      alt="Email template about REPO review" width="1248" height="2604" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/review.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/review.jpg">
                    <img src="./static/emails/review.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1340" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/sale.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/sale.jpg" class="img-fluid rounded" alt="Email template for sales"
                      width="1248" height="1620" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/schedule.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/schedule.jpg" class="img-fluid rounded"
                      alt="Email template connected with the schedule" width="1248" height="1768" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/security-alert.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/security-alert.jpg">
                    <img src="./static/emails/security-alert.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1272" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/shipped.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/shipped.jpg" class="img-fluid rounded"
                      alt="Email template informing about the shipment" width="1248" height="1006" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/stats.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/stats.jpg" class="img-fluid rounded"
                      alt="Email template about statistics" width="1248" height="1944" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/stats-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="Email template about statistics"
                    ...
                    <img src="./static/emails/stats-2.jpg" class="img-fluid rounded"
                      alt="Email template about statistics" width="1248" height="1564" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/subscribe.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/subscribe.jpg" class="img-fluid rounded"
                      alt="Email template about subscriptions" width="1248" height="1816" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/subscription.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/subscription.jpg" class="img-fluid rounded"
                      alt="Email template about confirmation of subscription" width="1248" height="1260" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/survey.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/survey.jpg" class="img-fluid rounded" alt="Email template about survey"
                      width="1248" height="1996" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/survey-emoji.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/survey-emoji.jpg">
                    <img src="./static/emails/survey-emoji.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1834" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/todo.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/todo.jpg" class="img-fluid rounded"
                      alt="Email template with a list of things to do" width="1248" height="1388" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/top-comments.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/top-comments.jpg" class="img-fluid rounded"
                      alt="Email template with the top comments" width="1248" height="1436" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/ui-colors.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/ui-colors.jpg" class="img-fluid rounded"
                      alt="Email template with available colors" width="1248" height="2008" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/ui-grid.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/ui-grid.jpg" class="img-fluid rounded"
                      alt="Email template with a grid system" width="1248" height="3296" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/ui-typography.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/ui-typography.jpg" class="img-fluid rounded"
                      alt="Email template about typography" width="1248" height="2360" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/uptime-report.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/uptime-report.jpg">
                    <img src="./static/emails/uptime-report.jpg" class="img-fluid rounded" alt=""
                      width="1248" height="1750" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/valentines-1.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/valentines-1.jpg" class="img-fluid rounded"
                      alt="Email template for Valentine's Day 1" width="1248" height="1868" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/valentines-2.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/valentines-2.jpg" class="img-fluid rounded"
                      alt="Email template for Valentine's Day 2" width="1248" height="2520" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/visitors-map.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/visitors-map.jpg" class="img-fluid rounded"
                      alt="Email template related with the vistitor map" width="1248" height="3006" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/welcome.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    data-bs-title="" data-bs-description="" data-bs-image="./static/emails/welcome.jpg">
                    <img src="./static/emails/welcome.jpg" class="img-fluid rounded" alt="" width="1248"
                      height="1484" />
                  </a>
                </div>
                <div class="col-4">
                  <a href="./static/emails/wishlist.jpg" data-bs-toggle="modal" data-bs-target="#email-modal"
                    ...
                    <img src="./static/emails/wishlist.jpg" class="img-fluid rounded"
                      alt="Email template with a wishlist update" width="1248" height="2388" />
                  </a>
                </div>
              </div>
            </div>
          </div>
          <div class="modal fade" id="email-modal" aria-hidden="true" aria-labelledby="email-modal-label"
            tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body p-0">
                  <div class="row g-0">
                    <div class="col-6">
                      <div class="bg-surface-secondary rounded-start p-6">
                    ...
                    <div class="col-6">
                      <div class="p-7">
                        ...
                        <div class="mt-6">
                          <a href="https://r.tabler.io/buy-emails" class="btn btn-primary w-100"
                            target="_blank">Buy emails for $29</a>
                        </div>
                      </div>
                    </div>
                  </div>
