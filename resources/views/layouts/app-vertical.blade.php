  ...
  <div class="page">
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-nav flex-row d-lg-none">
          ...
          @auth
            <div class="nav-item dropdown ms-2">
              <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm"
                  style="background-image: url(https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=066fd1&color=fff)">
                </span>
              </a>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
          @hasSection('sidebar')
            @yield('sidebar')
          @else
            <nav aria-label="Primary" class="navbar-nav pt-lg-3">
              <ul class="navbar-nav">
                <li class="nav-item">
    ...
    <header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
      <div class="container-xl">
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu" aria-controls="navbar-menu"
          aria-expanded="false" aria-label="Toggle secondary navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
