          ...
          <div class="card">
            <div class="row g-0">
              <div class="col-xxl-3 email-border border-end">
                <div class="offcanvas-xxl offcanvas-start h-100 file-offcanvas" tabindex="-1"
                  id="emailSidebaroffcanvas">
                  <div class="card-body h-100">
                    <div>
                      <a href="#" class="btn btn-primary btn-5 d-none d-sm-block" data-bs-toggle="modal"
                        data-bs-target="#modal-new-email">
                    ...
                    <div class="nav nav-vertical mt-3">
                      <a href="#" class="nav-link text-danger fw-bold">
                        <!-- Download SVG icon from http://tabler.io/icons/icon/inbox -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                          <path
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/clock -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/file -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                          <path d="M14 3v4a1 1 0 0 0 1 1h4" />
                          <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />
                        </svg>Draft<span class="badge badge-info ms-auto">32</span></a>
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/mail-up -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/trash -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                          <path d="M4 7l16 0" />
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/tag -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                      ...
                      <a href="#"
                        class="nav-link"><!-- Download SVG icon from http://tabler.io/icons/icon/alert-octagon -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-2 me-2">
                          <path
                    ...
                    <div class="mt-4">
                      ...
                      <div class="nav nav-vertical mt-2">
                    ...
                    <ul class="email-list">
                      <li>
                        <div class="email-sender-info">
                          ...
                          <span class="star-toggle"><!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Direct message on Twitter &nbsp;–&nbsp;
                            <span>@LucasKriebel - Very cool :) You have a new direct message. Open Twitter to read and
                              reply now.</span>
                          </a>
                        ...
                        <div class="email-action-icons">
                          <ul class="list-inline">
                            <li class="list-inline-item">
                              <a href="#"><!-- Download SVG icon from http://tabler.io/icons/icon/archive -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <li class="list-inline-item">
                              <a href="#"><!-- Download SVG icon from http://tabler.io/icons/icon/trash -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                  stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"
                                  focusable="false" class="icon icon-1">
                            ...
                            <li class="list-inline-item">
                              <a href="#">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                  stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"
                                  focusable="false" class="icon email-action-icons-item icon-2">
                            ...
                            <li class="list-inline-item">
                              <a href="#"><!-- Download SVG icon from http://tabler.io/icons/icon/clock -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                  stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"
                                  focusable="false" class="icon icon-1">
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Your ticket #48213 has been updated &nbsp;–&nbsp;
                            <span>Hi, we've added a detailed note to your request regarding billing. Please review the
                              update and let us know if anything looks
                              off.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">10 growth tactics you can try today &nbsp;–&nbsp;
                            <span>We curated a list of actionable ideas from top marketers to boost acquisition,
                              retention, and activation this quarter.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">[tabler] New issue assigned to you &nbsp;–&nbsp;
                            <span>Issue #3294: Update email inbox page to use data file. Please triage, add labels, and
                              provide an estimate.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Payout scheduled &nbsp;–&nbsp;
                            <span>A payout of $1,248.32 is scheduled for tomorrow. Funds typically arrive within 2
                              business days.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">You were invited to a file &nbsp;–&nbsp;
                            <span>Anna shared ‘Inbox redesign v3’ with you. Review the latest components and leave
                              feedback in comments.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Event confirmed for Fri 3 PM &nbsp;–&nbsp;
                            <span>Your meeting with Chris is confirmed for this Friday at 3 PM. A calendar invite with
                              the video link was attached.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">New followers this week &nbsp;–&nbsp;
                            <span>You gained 27 new followers. See who followed you and engage with their posts to grow
                              reach.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Today's top launches &nbsp;–&nbsp;
                            <span>Catch up on trending products you might like. Today's list features tools for design
                              and developer productivity.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Weekly summary: Inbox project &nbsp;–&nbsp;
                            <span>3 tasks completed, 2 comments, 1 new page added. Click through to see highlights and
                              next steps.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Billing alert threshold reached &nbsp;–&nbsp;
                            <span>Your usage exceeded the alert threshold for this month. Consider upgrading your plan
                              or adjusting limits.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Someone viewed your profile &nbsp;–&nbsp;
                            <span>See who looked at your profile this week. Strengthen your network by following up with
                              recent viewers.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Alert for: Tabler UI &nbsp;–&nbsp;
                            <span>New articles mentioning Tabler UI were found. Skim the summaries and set alerts for
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Stories you might like &nbsp;–&nbsp;
                            <span>Handpicked stories based on your reading history. Discover deep dives on design
                              systems and UX workflows.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Missed messages in #design &nbsp;–&nbsp;
                            <span>You have 14 unread messages across 3 channels. Catch up now to keep the conversation
                              moving.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">New error: TypeError in preview &nbsp;–&nbsp;
                            <span>Tabler preview threw TypeError: cannot read properties of undefined. Investigate stack
                              trace and recent commits.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">New shots from designers you follow &nbsp;–&nbsp;
                            <span>A fresh batch of inspiration is here. Explore new shots and save your favorites to
                              collections.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Plan your next getaway &nbsp;–&nbsp;
                            <span>Deals on stays you'll love this fall. Flexible dates and free cancellation on many
                              options.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Reminder: Standup in 10 minutes &nbsp;–&nbsp;
                            <span>Daily standup starts at 9:30 AM. Share yesterday's progress, today's plan, and
                              blockers.</span>
                          </a>
                      ...
                      <li>
                        ...
                        <div class="email-content">
                          <a href="#" class="email-subject">Exclusive 25% off for you &nbsp;–&nbsp;
                            <span>Save big on electronics this weekend only. Limited quantities—use code WEEKEND25 at
                              checkout.</span>
                          </a>
