...
<head>
  ...
  <title>Cards Masonry - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.
  </title>
          ...
          <div class="row row-cards" data-masonry='{"percentPosition": true }'>
              ...
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="200" viewBox="0 0 400 200" fill="transparent" stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="150" viewBox="0 0 400 150" fill="transparent" stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="400" viewBox="0 0 400 400" fill="transparent" stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="300" viewBox="0 0 400 300" fill="transparent" stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="350" viewBox="0 0 400 350" fill="transparent"
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="600" viewBox="0 0 400 600" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="700" viewBox="0 0 400 700" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="150" viewBox="0 0 400 150" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
                    <line x1="0" y1="0" x2="400" y2="150"></line>
                    <line x1="0" y1="150" x2="400" y2="0"></line>
                  </svg>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="250" viewBox="0 0 400 250" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="50" viewBox="0 0 400 50" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="400" viewBox="0 0 400 400" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
                    <line x1="0" y1="0" x2="400" y2="400"></line>
                    <line x1="0" y1="400" x2="400" y2="0"></line>
                  </svg>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card">
                <div class="card-body p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-100" preserveAspectRatio="none" width="400"
                    height="300" viewBox="0 0 400 300" fill="transparent"
                    stroke="var(--tblr-border-color, #b8cef1)">
                    <line x1="0" y1="0" x2="400" y2="300"></line>
                    <line x1="0" y1="300" x2="400" y2="0"></line>
                  </svg>
