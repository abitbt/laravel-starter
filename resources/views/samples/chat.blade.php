          ...
          <div class="card flex-fill">
            <div class="row g-0 flex-fill">
              <div class="col-12 col-lg-5 col-xl-3 border-end d-flex flex-column">
                ...
                <div class="card-body scrollable flex-fill p-0">
                  <div class="nav flex-column nav-pills" role="tablist">
                    <a href="#chat-1" class="nav-link mw-100 active p-3 text-start" id="chat-1-tab"
                      ...
                      <div class="row align-items-center flex-fill">
                        ...
                        <div class="col text-body">
                          <div>Paweł Kuna</div>
                          <div class="text-secondary text-truncate w-100">Sure Paweł, let me pull the latest updates.
                          </div>
                        </div>
                      </div>
                    </a>
                    <a href="#chat-1" class="nav-link mw-100 p-3 text-start" id="chat-1-tab" data-bs-toggle="pill"
                      ...
                      <div class="row align-items-center flex-fill">
                        ...
                        <div class="col text-body">
                          ...
                          <div class="text-secondary text-truncate w-100">
                            ...
                            update the <code>README</code> with the
                            setup instructions?
                          </div>
                        </div>
                      </div>
                    ...
                    <a href="#chat-1" class="nav-link mw-100 p-3 text-start" id="chat-1-tab" data-bs-toggle="pill"
                      ...
                      <div class="row align-items-center flex-fill">
                        ...
                        <div class="col text-body">
                          <div>Egan Poetz</div>
                          <div class="text-secondary text-truncate w-100">Oops, I forgot. I'll add that right away.
                          </div>
                        </div>
                            ...
                            <div class="chat-bubble chat-bubble-me">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  ...
                                  <div class="chat-bubble-date col-auto">09:32</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>Hey guys, I just pushed a new commit on the <code>dev</code> branch. Can you have a
                                  look and tell me what you think?</p>
                              </div>
                            </div>
                          </div>
                          <div class="col-auto"><span class="avatar avatar-1"
                            ...
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  ...
                                  <div class="chat-bubble-date col-auto">09:34</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Mallory Hulme</div>
                                  <div class="chat-bubble-date col-auto">09:40</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>I see you've refactored the <code>calculateStatistics</code> function. The code is
                                  much cleaner now.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble chat-bubble-me">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Paweł Kuna</div>
                                  <div class="chat-bubble-date col-auto">09:42</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                            ...
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  ...
                                  <div class="chat-bubble-date col-auto">09:43</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>The commit message is descriptive, too. Good job on mentioning the issue number it
                                  fixes.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Dunn Slane</div>
                                  <div class="chat-bubble-date col-auto">09:44</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>
                                  I noticed you added some new dependencies in the <code>package.json</code>. Did you
                                  also update the <code>README</code> with
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble chat-bubble-me">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Paweł Kuna</div>
                                  <div class="chat-bubble-date col-auto">09:45</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Mallory Hulme</div>
                                  <div class="chat-bubble-date col-auto">09:46</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble chat-bubble-me">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Paweł Kuna</div>
                                  <div class="chat-bubble-date col-auto">09:47</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Emmy Levet</div>
                                  <div class="chat-bubble-date col-auto">09:50</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
                                <p>Alright, once the <code>README</code> is updated, I'll merge this commit into the
                                  main branch. Nice work, Paweł.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col col-lg-6">
                            <div class="chat-bubble chat-bubble-me">
                              <div class="chat-bubble-title">
                                <div class="row">
                                  <div class="col chat-bubble-author">Paweł Kuna</div>
                                  <div class="chat-bubble-date col-auto">09:52</div>
                                </div>
                              </div>
                              <div class="chat-bubble-body">
