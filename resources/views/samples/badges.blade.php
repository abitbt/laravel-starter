                    ...
                    <div class="card-body">
                      ...
                      <div class="space-y">
                        <div class="badges-list">
                          ...
                          <span class="badge badge-sm"><!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                            ...
                            Left icon</span>
                          <span class="badge badge-sm">Right
                            icon<!-- Download SVG icon from http://tabler.io/icons/icon/arrow-right -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1">
                              <path d="M5 12l14 0" />
                          ...
                          <span
                            class="badge badge-icononly badge-sm"><!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="currentColor" aria-hidden="true" focusable="false" class="icon icon-2">
                              <path
                        ...
                        <div class="badges-list">
                          ...
                          <span class="badge"><!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1">
                              <path d="M5 12l5 5l10 -10" />
                          ...
                          <span
                            class="badge badge-icononly"><!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                        ...
                        <div class="badges-list">
                          ...
                          <span
                            class="badge badge-lg"><!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            Left icon</span>
                          <span class="badge badge-lg">Right
                            icon<!-- Download SVG icon from http://tabler.io/icons/icon/arrow-right -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                              stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"
                          ...
                          <span
                            class="badge badge-icononly badge-lg"><!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                              viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"
                              class="icon icon-2">
                              <path
              ...
              <div class="row row-cards">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <div class="btn-list">
                        <button class="btn">Default badge <span
                            class="badge bg-default text-default-fg ms-2">1</span></button>
                        <button class="btn">Blue badge <span
                            class="badge bg-blue text-blue-fg ms-2">2</span></button>
                        <button class="btn">Azure badge <span
                            class="badge bg-azure text-azure-fg ms-2">3</span></button>
                        <button class="btn">Indigo badge <span
                            class="badge bg-indigo text-indigo-fg ms-2">4</span></button>
                        <button class="btn">Purple badge <span
                            class="badge bg-purple text-purple-fg ms-2">5</span></button>
                        <button class="btn">Pink badge <span
                            class="badge bg-pink text-pink-fg ms-2">6</span></button>
                        <button class="btn">Red badge <span class="badge bg-red text-red-fg ms-2">7</span></button>
                        <button class="btn">Orange badge <span
                            class="badge bg-orange text-orange-fg ms-2">8</span></button>
                        <button class="btn">Yellow badge <span
                            class="badge bg-yellow text-yellow-fg ms-2">9</span></button>
                        <button class="btn">Lime badge <span
                            class="badge bg-lime text-lime-fg ms-2">10</span></button>
                        <button class="btn">Green badge <span
                            class="badge bg-green text-green-fg ms-2">11</span></button>
                        <button class="btn">Teal badge <span
                            class="badge bg-teal text-teal-fg ms-2">12</span></button>
                        <button class="btn">Cyan badge <span
                            class="badge bg-cyan text-cyan-fg ms-2">13</span></button>
                        <button class="btn">Dark badge <span
                            class="badge bg-dark text-dark-fg ms-2">14</span></button>
                        <button class="btn">Light badge <span
                            class="badge bg-light text-light-fg ms-2">15</span></button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="btn-list">
                        <button class="btn position-relative">
                          Default badge <span
                            class="badge bg-default text-default-fg badge-notification badge-pill">1</span>
                        </button>
                        <button class="btn position-relative">
                        ...
                        <button class="btn position-relative">
                          Indigo badge <span
                            class="badge bg-indigo text-indigo-fg badge-notification badge-pill">4</span>
                        </button>
                        <button class="btn position-relative">
                          Purple badge <span
                            class="badge bg-purple text-purple-fg badge-notification badge-pill">5</span>
                        </button>
                        <button class="btn position-relative">
                        ...
                        <button class="btn position-relative">Red badge <span
                            class="badge bg-red text-red-fg badge-notification badge-pill">7</span></button>
                        <button class="btn position-relative">
                          Orange badge <span
                            class="badge bg-orange text-orange-fg badge-notification badge-pill">8</span>
                        </button>
                        <button class="btn position-relative">
                          Yellow badge <span
                            class="badge bg-yellow text-yellow-fg badge-notification badge-pill">9</span>
                        </button>
                        <button class="btn position-relative">
                        ...
                        <button class="btn position-relative">
                          Green badge <span
                            class="badge bg-green text-green-fg badge-notification badge-pill">11</span>
                        </button>
                        <button class="btn position-relative">
                        ...
                        <button class="btn position-relative">
                          Light badge <span
                            class="badge bg-light text-light-fg badge-notification badge-pill">15</span>
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <div class="btn-list">
                        <button class="btn position-relative">Default badge <span
                            class="badge bg-default badge-notification badge-blink"></span></button>
                        ...
                        <button class="btn position-relative">Dark badge <span
                            class="badge bg-dark badge-notification badge-blink"></span></button>
                        <button class="btn position-relative">Light badge <span
                            class="badge bg-light badge-notification badge-blink"></span></button>
                      </div>
                    </div>
                  </div>
                </div>
