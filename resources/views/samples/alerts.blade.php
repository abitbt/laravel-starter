                  ...
                  <div class="alert alert-danger" role="alert">
                    <div class="alert-icon">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon alert-icon icon-2">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="alert alert-danger alert-dismissible" role="alert">
                    ...
                    An error occurred!
                    <a href="#" class="alert-action">Link</a><a class="btn-close" data-bs-dismiss="alert"
                      aria-label="close"></a>
                  </div>
