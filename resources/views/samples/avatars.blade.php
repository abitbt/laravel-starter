                ...
                <div class="card-body">
                  ...
                  <span class="avatar avatar-0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                      ...
                      stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon avatar-icon icon-2">
                  ...
                  <div class="row g-3">
                    <div class="col-6">
                      <div class="avatar-list avatar-list-stacked avatar-list-xxs">
                        <span class="avatar avatar-1" style="background-image: url(./static/avatars/000m.jpg)">
                        </span>
                    ...
                    <div class="col-6">
                      <div class="avatar-list avatar-list-stacked avatar-list-xxs">
                        <span class="avatar avatar-2 rounded-circle"
            ...
            <div class="col-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <span class="avatar avatar-3 rounded-circle"
                    style="background-image: url(./static/avatars/000m.jpg)"><span class="badge bg-red"></span>
                  </span>
                  <span class="avatar avatar-3 rounded-circle"
                    style="background-image: url(./static/avatars/052f.jpg)"><span class="badge bg-green"></span>
                  </span>
                  <span class="avatar avatar-3 rounded-circle"
                    style="background-image: url(./static/avatars/002m.jpg)"><span class="badge bg-blue"></span>
                  </span>
                  <span class="avatar avatar-3 rounded-circle"
                    style="background-image: url(./static/avatars/003m.jpg)"><span class="badge bg-yellow"></span>
                  </span>
                  <span class="avatar avatar-3 rounded-circle"
                    style="background-image: url(./static/avatars/000f.jpg)"><span class="badge bg-secondary"></span>
                  </span>
                </div>
              </div>
            </div>
            <div class="col-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <span class="avatar avatar-2" style="background-image: url(./static/avatars/000m.jpg)"><span
                      class="avatar-brand" style="background-image: url(./static/brands/netflix.svg)"></span>
                  </span>
                  <span class="avatar avatar-2" style="background-image: url(./static/avatars/052f.jpg)"><span
                      class="avatar-brand" style="background-image: url(./static/brands/amazon.svg)"></span>
                  </span>
                  <span class="avatar avatar-2" style="background-image: url(./static/avatars/002m.jpg)"><span
                      class="avatar-brand" style="background-image: url(./static/brands/messenger.svg)"></span>
                  </span>
                  <span class="avatar avatar-2" style="background-image: url(./static/avatars/003m.jpg)"><span
                      class="avatar-brand" style="background-image: url(./static/brands/figma.svg)"></span>
                  </span>
                  <span class="avatar avatar-2" style="background-image: url(./static/avatars/000f.jpg)"><span
                      class="avatar-brand" style="background-image: url(./static/brands/twitch.svg)"></span>
                  </span>
                </div>
              </div>
            </div>
